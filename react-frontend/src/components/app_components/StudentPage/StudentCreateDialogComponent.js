...
const StudentCreateDialogComponent = (props) => {
    ...
    const setId = (id) => { setValByKey("Image", id);  };
...
<div className="col-12 field">
                <span className="align-items-center">
                    ...
                    <UploadFilesToS3 type={'create'} user={props.user} id={urlParams.id} serviceName="student" onUploadComplete={setId} onFileLoaded={onFileLoaded}/>
                </span>
                <small className="p-error">
